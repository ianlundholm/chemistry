...
const Card = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & { variant?: "default" | "paper" }
>(({ className, variant = "default", ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl p-5 shadow-[var(--shadow-border)]",
      variant === "default" && "bg-surface text-fg",
      variant === "paper" && "bg-paper text-paper-ink shadow-[var(--shadow-paper)]",
      className,
    )}
    {...props}
  />
